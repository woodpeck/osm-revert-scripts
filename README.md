...
| [`changeset_graph.pl`](changeset_graph.pl)  | [`ChangesetGraph.pm`](lib/ChangesetGraph.pm)  | draws changeset dependency graph  |
| [`complex_revert.pl`](complex_revert.pl)  |   | reverts a group of interdependent changesets  |
| [`delete.pl`](delete.pl)  | [`Delete.pm`](lib/Delete.pm)  | deletes or redacts an object  |
...
| [`trace.pl`](trace.pl)  | [`Trace.pm`](lib/Trace.pm)  | uploads gpx traces  |
| [`tokens.pl`](tokens.pl)  |   | requests oauth2 login tokens  |
| [`undelete.pl`](undelete.pl)  | [`Undelete.pm`](lib/Undelete.pm)  | undeletes an object; see comment in-file for differences to undo  |
| [`undo.pl`](undo.pl)  | [`Undo.pm`](lib/Undo.pm)  | undoes one change to one object  |
| [`user_changesets.pl`](user_changesets.pl)  | [`UserChangesets.pm`](lib/UserChangesets.pm)  | bulk downloads changesets by given user; there are also simpler shell script versions listed below  |
